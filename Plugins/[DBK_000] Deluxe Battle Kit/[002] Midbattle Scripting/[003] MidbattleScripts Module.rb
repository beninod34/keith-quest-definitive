...
################################################################################ 
  ...
  LITTLE_BROTHER = {
    ...
    "BeforeItemUse_foe" => {
      "setSpeaker" => nil,
      "editWindow" => [nil, "bw choice"],
      "speech" => "I'm gonna beat you!"
    },
    "BeforeLastSwitchIn_foe" => {
      "setSpeaker" => nil,
      "editWindow" => [nil, "bw choice"],
      "speech" => "No way, give me 6 more Pokemon to use!"
    },
    "BeforeLastSwitchIn_player" => {
      "setSpeaker" => nil,
      "editWindow" => [nil, "bw choice"],
      "speech" => "HAHA, YES! I'M GONNA WIN! I'M GONNA WIN!"
    },
    "BattleEndLoss" => {
      "setSpeaker" => nil,
      "editWindow" => [nil, "bw choice"],
      "speech" => "I WIN! I WIN! I WIN, I WIN, I WIN!!!!!!!!!!!!"
    }
  }
