...
def renderBadgeAnimation(badge_number = 0)
  ...
  for j in 0...8
    ...
    fp["#{j}"].bitmap = Bitmap.new("Graphics/Transitions/badgeShine")
    fp["#{j}"].ox = 0
  ...
  for j in 0...16
    ...
    fp["p#{j}"].bitmap = Bitmap.new("Graphics/Transitions/badgeParticle")
  ...
  fp["bg"].bitmap = screen
  fp["bg"].bitmap.blur
  fp["bg"].bitmap.blt(0, 0, Bitmap.new("Graphics/Transitions/badgeShade"), Rect.new(0,0,viewport.rect.width,viewport.rect.height))
  fp["eff"] = Sprite.new(viewport)
  fp["eff"].bitmap = Bitmap.new("Graphics/Transitions/badgeEffect")
  ...
  isBack = false
  bmp = Bitmap.new("Graphics/Transitions/getBadge#{badge_number}")
  height = bmp.height
  width = bmp.height
